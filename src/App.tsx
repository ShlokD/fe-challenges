...
function App() {
  return (
    <div className="p-4 flex flex-col">
      ...
      <p className="md:text-lg text-sm  text-center p-2 md:p-3">
        A collection of web mini-apps and widgets
      </p>
      <ul className="flex flex-row gap-2 items-stretch justify-around p-1 w-full flex-wrap">
        <li className="md:text-lg text-sm  text-sm w-1/4 text-center my-2 bg-blue-500 text-white p-2 md:p-3 rounded-lg">
        ...
        <li className="md:text-lg text-sm  w-1/4 text-center flex flex-col justify-center my-2 bg-blue-500 text-white p-2 md:p-3 rounded-lg">
          <Link to={`/brainn-lottery`}>Brainn Lottery</Link>
        </li>
        <li className="md:text-lg text-sm  w-1/4 text-center my-2 flex flex-col justify-center bg-blue-500 text-white p-2 md:p-3 rounded-lg">
        ...
        <li className="md:text-lg text-sm  w-1/4 text-center my-2 bg-blue-500 text-white p-2 md:p-3 rounded-lg">
          <Link to={`/notifications-panel`}>Notifications Panel</Link>
        </li>
        <li className="md:text-lg text-sm  w-1/4 text-center my-2 bg-blue-500 text-white p-2 md:p-3 rounded-lg">
        ...
        <li className="md:text-lg text-sm  w-1/4 text-center my-2 bg-blue-500 text-white p-2 md:p-3 rounded-lg">
          <Link to={`/donation-page`}>Donation Page</Link>
        </li>
        <li className="md:text-lg text-sm  w-1/4 text-center my-2 bg-blue-500 text-white p-2 md:p-3 rounded-lg">
          <Link to={`/export-image`}>Export Image</Link>
        </li>
        <li className="md:text-lg text-sm  w-1/4 text-center my-2 bg-blue-500 text-white p-2 md:p-3 rounded-lg">
          <Link to={`/notifications-popup`}>Notifications Popup</Link>
        </li>
        <li className="md:text-lg text-sm  w-1/4 text-center my-2 bg-blue-500 text-white p-2 md:p-3 rounded-lg">
          <Link to={`/folder-structure`}>Folder Structure</Link>
        </li>
        <li className="md:text-lg text-sm  w-1/4 text-center my-2 bg-blue-500 text-white p-2 md:p-3 rounded-lg">
          <Link to={`/calendar-reminder`}>Calendar Reminder</Link>
        </li>
        <li className="md:text-lg text-sm  w-1/4 text-center my-2 bg-blue-500 text-white p-2 md:p-3 rounded-lg">
        ...
        <li className="md:text-lg text-sm  w-1/4 text-center my-2 bg-blue-500 text-white p-2 md:p-3 rounded-lg">
          <Link to={`/hours-tracker`}>Hours Tracker</Link>
        </li>
      </ul>
    </div>
  );
